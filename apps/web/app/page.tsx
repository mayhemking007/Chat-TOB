  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-8">
      <div className="w-full max-w-sm space-y-6">
        <h1 className="text-2xl font-semibold">Create workspace to get started</h1>
        <p className="text-gray-600">You don’t have any workspaces yet. Create one to continue.</p>
